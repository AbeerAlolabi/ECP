      ...
      <div id="main">
        ...
        <div class="div_breadcrumb">
          <ul class="breadcrumb">
              ...
              <li><a href="#"  class="current">Review users blogs</a></li>
        ...
        <?php
          ...
          $sql = "select title, briefDescription, Description, nameOfUser, image, blogId from blogs where status='onReview'";
            ...
            while($row = mysqli_fetch_assoc($result)){
              ...
              <div class='col-11  blog_Main'  id='blogBtn_".$i."'>
                ...
                <form  action='php/updateBlog.php'  method='get' >
                  <input type='submit' value='×' class='deleteBlogBtn' id='deleteBlogBtn_".$i."' name='BlogDelete' style='
                      font-size: 27px;
                      font-weight: 600;
                      color: #043f3d;
                      float: right;
                ...
                <button class='edit_btn continue_reading_btn' id='blog_".$i."_Btn'>review</button>
              </div>
              <!-- blog 1 modal -->
                      ...
                      <div class='container'>
                        <div class='row'>
                          <div class='col-12' >
                            ...
                            <input type='submit' value='approve' name='save' style='float: right;margin: 8px 0px;background: #444;'/>
                          </div>
